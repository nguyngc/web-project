const services = [
  {
    serviceName: "Comprehensive Eye Exams",
    ...
    benefits: "Early detection of eye diseases; Updated prescriptions; Prevention of vision problems",
    isActive: true
  },
  {
    serviceName: "Eyeglasses & Frames",
    ...
    frequency: "As needed",
    features: "Designer Frames; Custom Prescription Lenses; Antireflective & UV Coatings; Blue Light Filtering",
    benefits: "Personalized style and fit; Improved vision clarity; Protection against UV and blue light; Durable and comfortable eyewear",
    isActive: true,
  },
  {
    ...
    features: "Daily Disposables; Monthly Lenses; Toric Lenses for Astigmatism; Multifocal Lenses",
    benefits: "Comfortable and precise fit; Clear vision without glasses; Options for astigmatism and presbyopia; Convenient daily or monthly wear",
    isActive: true,
  },
  {
    serviceName: "LASIK Surgery",
    ...
    price: "Starting at €1500 per eye",
    frequency: "One-time procedure with follow-up visits",
    features: "Bladeless LASIK; Custom Wavefront Technology; Free Consultation; Lifetime Warranty",
    benefits: "Reduced or eliminated need for glasses/contacts; Quick recovery and long-lasting results; Safe and precise correction; Improved quality of life and convenience",
    isActive: true,
  },
  {
    serviceName: "Disease Management",
    ...
    features: "Glaucoma Treatment; Cataract Surgery; Diabetic Eye Care; Macular Degeneration Management",
    benefits: "Early detection and prevention of vision loss; Personalized treatment plans; Advanced surgical and non-surgical options; Ongoing monitoring for long-term eye health",
    isActive: true,
  },
  {
    serviceName: "Pediatric Eye Care",
    ...
    features: "Vision Screenings; Lazy Eye (Amblyopia) Treatment; Eye Coordination Assessment; Sports Vision Training",
    benefits: "Early detection of childhood vision issues; Improved eye coordination and development; Comfortable, child-friendly environment; Support for academic and sports performance",
    isActive: true,
  }
];
