  ...
  return (
    <div className="flex flex-col items-start p-4 gap-4 w-[734px] h-[182px] bg-white border border-[#159EEC] border-l-[4px] rounded-[14px]">
      ...
      <div className="flex flex-row gap-3">
        <button className="flex items-center justify-center gap-2 px-3 py-1.5 rounded-lg bg-gradient-to-b from-[#159EEC]/50 to-[#159EEC] text-white text-sm font-medium">
          <FileText className="w-4 h-4 text-white" />
          View Details
        </button>
        <button className="flex items-center justify-center gap-2 px-3 py-1.5 rounded-lg border border-[#159EEC] text-[#159EEC] text-sm font-medium bg-white">
