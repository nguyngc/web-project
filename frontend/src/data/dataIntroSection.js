...
const introSection = {
    home: {
        ...
        description: "Your trusted partner for comprehensive eye care services.\nWe combine advanced technology with compassionate care to protect and enhance your vision.",
        card: [
    ...
    about: {
        ...
        card: [
            ...
            {icon: Eye,title: "25+ ",description: "Years of Services",},
            {icon: Award,title: "15+",description: "Expert Staff",},
