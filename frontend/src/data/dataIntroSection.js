import { Eye, Award, Heart, Wallet, HeartPulse, ShieldCheck } from "lucide-react";
const introSection = {
    home: {
        ...
        card: [
            {
                ...
                description: "Most major vision and medical insurance plans",
            },
            {
                icon: Wallet,
                title: "Flexible Payment ",
                description: "Payment plans available for all services",
            },
            {
                icon: HeartPulse,
                title: "Affordable Care",
                description: "Competitive pricing and special packages.",
            },
        ]
    },
